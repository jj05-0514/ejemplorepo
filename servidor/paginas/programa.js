...
function validarEmail() {
    ...
    if (expresion.test(email)) {
        document.getElementById('advertencia2').innerHTML = 'Email correcto'; return true
    }
    else {
        document.getElementById('advertencia2').innerHTML = 'Email incorrecto'; return false
    }
}
...
function validarPassword() {
    ...
    if (expresion.test(password)) {
        document.getElementById('advertencia3').innerHTML = 'Password correcto'; return true
    }
    else {
        document.getElementById('advertencia3').innerHTML = 'Password incorrecto'; return false
    }
}
